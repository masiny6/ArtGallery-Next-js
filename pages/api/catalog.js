        ...
        filter: {
            author: {
                ...
                elementsSelect: [
                    {
                      label: 'А',
                      options: [{value: "Абулафия Крайнова", label: "Абулафия Крайнова"}, {value: "Арменинов Тринедул", label: "Арменинов Тринедул"}, {value: "Ассадулин Нефёдов", label: "Ассадулин Нефёдов"}, {value: "Ашихмин Шадурахов", label: "Ашихмин Шадурахов"}],
                    },
                    {
                      label: 'Б',
                      options: [{value: "Бабурин Константин", label: "Бабурин Константин"}, {value: "Бабуркин Вениамин", label: "Бабуркин Вениамин"}, {value: "Балутин Перламутр", label: "Балутин Перламутр"}, {value: "Бенвенист Трамп", label: "Бердюгин Битюг"}, {value: "Бердюгин Битюг", label: "Бердюгин Битюг"}],
                    },
                  ]
            },
            genre: {
