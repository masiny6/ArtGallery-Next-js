          ...
          <div className="centering main-header__centering">
            ...
            <OutsideClickHandler
              ...
              <ul className="list-etc">
                ...
                <li className="list-etc__elem">
                  <a className="list-etc__link search" href="#">
                    <svg className="svg-search" viewBox="0 0 4 4" onClick={toggleSearchHandler}>
              ...
              <div className="languages">
                ...
                > 
                  {!!data.lang.desktopStatic ? <span className="languages__ru" onClick={toggleLanguageHandler}>{data.lang.desktopStatic.name}</span> : undefined}
                
                <ul className={cn("languages-list", {"languages-list-js" : !state.showLanguage})}>
