                ...
                <div className="centering">
                    <div className="main-footer__up">
                        <div className="about-us hidden-tablet">
                            <h6 className="about-us__title general-title">{!!data.aboutArtGallery ? data.aboutArtGallery.title : undefined}</h6>
                            <ul className="about-us__list general-list">
                                {!!data.aboutArtGallery ? data.aboutArtGallery.elements.map((item, key) => (
                        ...
                        <div className="buyers hidden-tablet">
                            <h6 className="buyers__title general-title">{!!data.buyers ? data.buyers.title : undefined}</h6>
                            <ul className="buyers__list general-list">
                            {!!data.buyers ? data.buyers.elements.map((item, key) => (
                        ...
                        <div className="catalog hidden-tablet">
                            <h6 className="catalog__title general-title">{!!data.catalog ? data.catalog.title : undefined}</h6>
                            <ul className="catalog__list general-list">
                            {!!data.catalog ? data.catalog.elements.map((item, key) => (
                        ...
                        <div className="contact">
                            ...
                            <ul className="contact__list">
                                <li className="contact__elem"><a className="contact__tel" href={`tel:${data.contact.tel.replace(/[^+\d]/g, '')}`}>{!!data.contact ? data.contact.tel : undefined}</a>
                                </li>
                                ...
                                <li className="contact__elem">
                                    ...
                                    {!!data.contact ? <address className="contact__address">{data.contact.address[0]},<br/> {data.contact.address[1]}</address> : undefined}
                                </li>
                            </ul>
                        </div>
                        <div className="social-and-payer">
                            <div className="social-network">
                                <h6 className="social-network__title general-title">{!!data.socialNetwork ? data.socialNetwork.title : undefined}</h6>
                            ...
                            <div className="payment-system">
                                <h6 className="payment-system__title general-title">{!!data.paymentsSystems ? data.paymentsSystems.title : undefined}</h6>
                                <img className="payment-system__photo" src={!!data.paymentsSystems ? data.paymentsSystems.paymentsURL : undefined} alt=""/>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="painting-footer_down">
                <div className="centering">
                    <div className="main-footer__down">
                        ...
                        <p className="copyright">{!!data.copyright ? data.copyright : undefined}</p>
