    ...
    return(
        <header className="main-header main-header-white">
          <div className="centering main-header__centering">
            ...
            <nav className={cn("main-navigation", "main-navigation-white", {"main-navigation-js" : !(state.showHeader && state.valueHeader === "mobile-menu")})}>
            ...
            <div className="account-and-etc">
              ...
              <ul className="list-etc">
                ...
                <li className="list-etc__elem list-etc__elem-white"><a className="list-etc__link list-etc__link-white search" href="#">
                  <svg className="svg-search svg-search-white" onClick={toggleSearchHandler} viewBox="0 0 4 4">
              ...
              <div className={cn("search-centering", {"search-centering-js" : !(state.showSearch)})}>
              ...
              <OutsideClickHandler
                ...
                > 
                {!!data.lang.desktopStatic ? <span className="languages__ru languages__ru-white" onClick={toggleLanguageHandler}>{data.lang.desktopStatic.name}</span> : undefined}
                <ul className={cn("languages-list", {"languages-list-js" : !state.showLanguage}, "languages-list-white")}>
